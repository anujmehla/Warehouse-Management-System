...
public class Items extends javax.swing.JFrame {
    ...
    public Items() {
        ...
        PreparedStatement smt = conn.prepareStatement("select * from items");
        ResultSet rs ;
        rs = smt.executeQuery();
            while(rs.next())
            {
            ...
            s3=rs.getInt(3);
            s4=rs.getInt(4);
            if(rs.getInt(5)==0){s5="No";} else{s5="Yes";}
    ...
    private void initComponents() {
        ...
        items.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        items.setFont(new java.awt.Font("Century Schoolbook", 0, 12)); // NOI18N
        ...
        items.setGridColor(new java.awt.Color(0, 0, 0));
