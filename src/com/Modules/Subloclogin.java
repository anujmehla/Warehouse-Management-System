 ...
 * @author My
 */
public class Subloclogin extends javax.swing.JFrame {

    /**
     * Creates new form Subloclogin
     */
    public Subloclogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Sub Location Incharge Login");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Subloclogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Subloclogin().setVisible(true);
            }
        });
    }
